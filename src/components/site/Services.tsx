...
const SERVICES: Service[] = [
  {
    ...
    title: "Private",
    italic: "1-on-1 Yoga",
    blurb: "Live one-to-one sessions shaped around your level, goals and schedule.",
  ...
  },
  {
    ...
    bullets: ["Practice-Safety Conversation", "Lifestyle Planning", "Habit Building", "Wellness Roadmap"],

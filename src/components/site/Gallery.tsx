...
const ALL: Item[] = [
  ...
  { src: masterGroup.url, alt: "Group practice", cat: "Community" },
  { src: eventA.url, alt: "Community gathering", cat: "Community" },
  // Transformations (3)
  ...
  // Events (3)
  { src: eventB.url, alt: "Celebration moment", cat: "Events" },
  ...
  { src: acroArch.url, alt: "Retreat group practice", cat: "Retreats" },
];
          ...
          {items.map((item, idx) => (
            ...
            >
              <img src={item.src} alt={item.alt} loading="lazy"
                className="h-[220px] w-full object-cover transition-transform duration-[1400ms] ease-out group-hover:scale-[1.08] sm:h-[260px] md:h-[300px]" />

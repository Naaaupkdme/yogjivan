...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-[linear-gradient(180deg,color-mix(in_oklab,var(--onyx)_44%,transparent),color-mix(in_oklab,var(--onyx)_76%,transparent)_42%,color-mix(in_oklab,var(--onyx)_92%,transparent))] md:bg-[linear-gradient(180deg,color-mix(in_oklab,var(--onyx)_28%,transparent),color-mix(in_oklab,var(--onyx)_72%,transparent)_54%,color-mix(in_oklab,var(--onyx)_90%,transparent))]" />
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_18%,color-mix(in_oklab,var(--gold)_12%,transparent),transparent_26%),radial-gradient(circle_at_80%_18%,color-mix(in_oklab,var(--gold-soft)_10%,transparent),transparent_30%),radial-gradient(circle_at_50%_75%,color-mix(in_oklab,var(--gold)_8%,transparent),transparent_36%)] md:bg-[radial-gradient(circle_at_20%_25%,color-mix(in_oklab,var(--gold)_18%,transparent),transparent_30%),radial-gradient(circle_at_80%_18%,color-mix(in_oklab,var(--gold-soft)_14%,transparent),transparent_32%),radial-gradient(circle_at_50%_75%,color-mix(in_oklab,var(--gold)_9%,transparent),transparent_38%)]" />

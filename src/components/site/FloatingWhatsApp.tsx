...
export function FloatingWhatsApp() {
  return (
    <a
      ...
      className="fixed right-4 z-40 grid h-14 w-14 place-items-center rounded-full border border-white/15 text-[color:var(--foreground)] shadow-[0_22px_60px_-18px_rgba(0,0,0,0.45)] transition-transform hover:scale-105 sm:right-5 bottom-[88px] md:bottom-5"
      style={{

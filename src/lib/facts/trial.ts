// SOURCE OF TRUTH — Introductory trial offer.
// One consistent wording. Never contradict this anywhere.

export const TRIAL = {
  headline: "3 days free + one complimentary private session",
  days: 3,
  includesPrivateSession: true,
  cardRequired: false,
  oncePerStudent: true,
  summary:

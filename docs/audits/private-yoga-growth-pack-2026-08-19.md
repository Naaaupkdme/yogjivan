...
- `ContactSection.tsx`: visitor-facing reply-time guarantees removed ("WhatsApp & Zalo replies usually within 5 minutes", "Replies within 5 min", "Average response · under 5 minutes") → neutral "We'll follow up on WhatsApp." / "Online · WhatsApp & Zalo" / "Our team will follow up on WhatsApp."
